...
const dictionaries: Record<Language, Translations> = {
  en: {
    ...
    // 自定义标的
    customSymbol: 'Custom Asset',
    customSymbolPlaceholder: 'e.g. TQQQ',
    customSymbolLabel: 'Custom (3x)',
    customWeight: 'Custom Target %',
    dcaCustom: 'DCA (Custom)',
    fetchingData: 'Fetching historical data...',
    fetchSuccess: 'Data loaded',
    fetchError: 'Failed to load data',
    customDataNote: 'Fetched from Yahoo Finance (cached 24h)',
    customDataRange: 'Data range',
    retryFetch: 'Retry',
    fetchManually: 'Fetch',
    fetchSource1: 'Yahoo Finance',
    fetchSource2: 'Stooq',
    fetchSources: 'Yahoo → Stooq (4 fallbacks)',
  },
  fr: {
    ...
    strat_dipBuying: 'Achat sur Repli (5-États)',
    ...
    // 自定义标的
    customSymbol: 'Actif Personnalisé',
    customSymbolPlaceholder: 'ex. TQQQ',
    customSymbolLabel: 'Perso (3x)',
    customWeight: 'Perso Cible %',
    dcaCustom: 'DCA (Perso)',
    fetchingData: 'Récupération des données...',
    fetchSuccess: 'Données chargées',
    fetchError: 'Échec du chargement',
    customDataNote: 'Source: Yahoo Finance (cache 24h)',
    customDataRange: 'Plage de données',
    retryFetch: 'Réessayer',
    fetchManually: 'Récupérer',
    fetchSource1: 'Yahoo Finance',
    fetchSource2: 'Stooq',
    fetchSources: 'Yahoo → Stooq (4 tentatives)',
  },
  'zh-CN': {
    appTitle: 'QQQ 回测工具',
    profiles: '配置方案',
    ...
    monitorDisclaimer: '实验性存量资金风险敎口及增量资金信号。非实时交易信号，不构成投资建议。',
    // 自定义标的
    customSymbol: '自定义标的',
    customSymbolPlaceholder: '如 TQQQ',
    customSymbolLabel: '自定义 (3x)',
    customWeight: '自定义标的比例',
    dcaCustom: '定投 (自定义)',
    fetchingData: '正在抓取历史数据...',
    fetchSuccess: '数据加载成功',
    fetchError: '数据抓取失败',
    customDataNote: '来源：Yahoo Finance（缓再24小时）',
    customDataRange: '数据范围',
    retryFetch: '重试',
    fetchManually: '手动抓取',
    fetchSource1: 'Yahoo Finance',
    fetchSource2: 'Stooq',
    fetchSources: 'Yahoo → Stooq（4级回退）',
  },
  'zh-TW': {
    appTitle: 'QQQ 回測工具',
    profiles: '配置方案',
    ...
    monitorDisclaimer: '實驗性存量資金風险敎口及增量資金信號。非實時交易信號，不構成投資建議。',
    // 自定义標的
    customSymbol: '自訂標的',
    customSymbolPlaceholder: '如 TQQQ',
    customSymbolLabel: '自訂 (3x)',
    customWeight: '自訂標的比例',
    dcaCustom: '定投 (自訂)',
    fetchingData: '正在抓取歷史資料...',
    fetchSuccess: '資料載入成功',
    fetchError: '資料抓取失敗',
    customDataNote: '來源：Yahoo Finance（快取 24 小時）',
    customDataRange: '資料範圍',
    retryFetch: '重試',
    fetchManually: '手動抓取',
    fetchSource1: 'Yahoo Finance',
    fetchSource2: 'Stooq',
    fetchSources: 'Yahoo → Stooq（4級回退）',
  },
}
